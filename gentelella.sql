...
/*!40000 ALTER TABLE `department`
    DISABLE KEYS */;
INSERT INTO `department` (`id`, `name`, `desc`, `pid`)
VALUES (10, '综合部', '综合管理', NULL),
       (20, '质量部', '质量管理', NULL),
       (30, '采购部', '采购管理', NULL),
       (40, '研发部', '项目研发', NULL),
       (50, '生产部', '生产事项', NULL),
...
VALUES (1, '主页', NULL, NULL),
       (2, '系统管理', NULL, NULL),
       (3, '部门管理', NULL, NULL),
       (4, '员工管理', NULL, NULL),
       (5, '项目管理', NULL, NULL),
       (101, '控制台', '/common/index.do', 1),
       (201, '菜单', '/menu/index.do', 2),
       (202, '角色', '/role/index.do', 2),
       (203, '权限', '/perm/index.do', 2),
       (204, '角色菜单', '/role_menu/index.do', 2),
       (205, '角色权限', '/role_perm/index.do', 2),
       (301, '部门信息', '/depart/index.do', 3),
       (401, '员工信息', '/employ/index.do', 4);
/*!40000 ALTER TABLE `menu`
    ENABLE KEYS */;
...
-- Dumping data for table gentelella.permission: ~5 rows (大约)
/*!40000 ALTER TABLE `permission`
    DISABLE KEYS */;
INSERT INTO `permission` (`id`, `name`, `desc`, `url`)
VALUES (1, 'addUser', '新增', '/user/addUser.do'),
...
/*!40000 ALTER TABLE `role_menu`
    DISABLE KEYS */;
INSERT INTO `role_menu` (`id`, `rid`, `mid`)
VALUES (1, 1, 1),
       (2, 1, 2),
       (3, 1, 3),
       (4, 1, 4),
...
-- Dumping data for table gentelella.role_permission: ~6 rows (大约)
...
/*!40000 ALTER TABLE `user`
    DISABLE KEYS */;
INSERT INTO `user` (`id`, `username`, `password`, `remember_me`, `email`, `gender`, `telephone`, `salt`, `create_time`)
VALUES (1, 'ximen', 'a7d59dfc5332749cb801f86a24f5f590', 'false', '1403473722@qq.com', 'male', '18503817798',
        'e5ykFiNwShfCXvBRPr3wXg==', '2019-08-24 10:25'),
       (2, 'dongsheng', '43e28304197b9216e45ab1ce8dac831b', 'false', '18503817798@163.com', 'female', '18236887931',
        'jPz19y7arvYIGhuUjsb6sQ==', '2019-08-24 10:25');
/*!40000 ALTER TABLE `user`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `user_dept`
    DISABLE KEYS */;
INSERT INTO `user_dept` (`id`, `uid`, `dept_id`)
VALUES (1, 1, 101),
       (2, 2, 40);
/*!40000 ALTER TABLE `user_dept`
    ENABLE KEYS */;
